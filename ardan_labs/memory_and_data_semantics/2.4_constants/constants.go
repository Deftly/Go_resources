...
The compiler can perform implicit conversions of untyped constants.
*/
...
func main() {
  ...
  // Type Constants still use the constant type system but their precision
  // is restricted.
  ...
  // Const thrid will be of kind floating point.
